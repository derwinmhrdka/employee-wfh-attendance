      ...
      <div className="table-responsive">
        <table className="table table-bordered align-middle">
          <thead className="table-light text-center">
            <tr>
              {mode === 'admin' && (
                <th style={{ backgroundColor: '#d9d9d9', textAlign: 'center' }}>ID - Name</th>
              )}
              <th style={{ backgroundColor: '#d9d9d9', textAlign: 'center' }}>Date</th>
              <th style={{ backgroundColor: '#d9d9d9', textAlign: 'center' }}>Clock In</th>
              <th style={{ backgroundColor: '#d9d9d9', textAlign: 'center' }}>Clock Out</th>
            </tr>
          </thead>
          <tbody>
